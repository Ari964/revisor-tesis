...
const navItems = [
  ...
  { href: '/thesis-generator', label: 'Generador de Tesis', icon: GraduationCap, roles: ['ADMIN', 'COORDINATOR', 'ADVISOR', 'STUDENT'] },
  { href: '/dashboard/orcid', label: 'Mi ORCID', icon: BookOpen, roles: ['ADVISOR'] },
